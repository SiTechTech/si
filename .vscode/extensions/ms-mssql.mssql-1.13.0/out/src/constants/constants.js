...
exports.cmdCreateAzureFunction = 'mssql.createAzureFunction';
...
// Azure Functions
exports.azureFunctionsExtensionName = 'ms-azuretools.vscode-azurefunctions';
exports.sqlConnectionString = 'SqlConnectionString';
exports.linkToAzureFunctionExtension = 'https://docs.microsoft.com/azure/azure-functions/functions-develop-vs-code';
exports.sqlBindingsDoc = 'https://aka.ms/sqlbindings';
exports.defaultSqlBindingTextLines = [
...
exports.defaultBindingResult = 'return new OkObjectResult(responseMessage);';
exports.sqlBindingResult = `return new OkObjectResult(result);`;
exports.azureFunctionLocalSettingsFileName = 'local.settings.json';
exports.sqlExtensionPackageName = 'Microsoft.Azure.WebJobs.Extensions.Sql';
