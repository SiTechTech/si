...
const azureFunctionsService_1 = require("../services/azureFunctionsService");
...
class MainController {
    ...
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (didInitialize) {
                ...
                this.azureFunctionsService = new azureFunctionsService_1.AzureFunctionsService(serviceclient_1.default.instance);
    ...
    initializeObjectExplorer() {
        ...
        this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdCreateAzureFunction, (node) => __awaiter(this, void 0, void 0, function* () {
            const connectionDetails = connectionCredentials_1.ConnectionCredentials.createConnectionDetails(node.connectionInfo);
            const connectionString = yield this._connectionMgr.getConnectionString(connectionDetails, false, false);
            yield this.azureFunctionsService.createAzureFunction(connectionString, node.metadata.schema, node.metadata.name);
        })));
    }
    /**
    ...
    onRunQuery(callbackThis) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this._connectionMgr.refreshAzureAccountToken(uri);
                let title = path.basename(editor.document.fileName);
                let querySelection;
