        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (connectionCreds.authenticationType === Constants.azureMfa) {
                ...
                if (!connectionCreds.azureAccountToken || connectionCreds.expiresOn - currentTime < maxTolerance) {
                    ...
                    let azureAccountToken = yield this.azureController.refreshToken(account, this.accountStore, providerSettings_1.default.resources.databaseResource);
                    if (!azureAccountToken) {
                        ...
                        if (refreshResult === LocalizedConstants.refreshTokenLabel) {
                            yield this.azureController.getTokens(profile, this.accountStore, providerSettings_1.default.resources.databaseResource);
                        }
                        else {
