...
class ConnectionUI {
    ...
    promptForConnection(ignoreFocusOut = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const selection = yield this.promptItemChoice({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (profile.accountId) {
                ...
                if (selection === LocalizedConstants.azureAddAccount) {
                    profile = yield this.connectionManager.azureController.getTokens(profile, this._accountStore, providerSettings_1.default.resources.azureManagementResource);
                }
                let account = this._accountStore.getAccount(profile.accountId);
                this.connectionManager.accountService.setAccount(account);
            }
    ...
    createFirewallRule(profile, serverName, ipAddress, account) {
        return __awaiter(this, void 0, void 0, function* () {
